...
const UpElections = () => {
  ...
  const getElections = async () => {
    ...
    try {
      ...
      // Filter elections to show only upcoming ones
      const upcomingElections = response.data.filter((election) => {
        const electionDate = new Date(election.startDate); // Adjust field name if needed
